...
struct Color
{
    ...
    {
        return new Color(
            (byte)Math.Max(R - 255 * amount, 0),
            (byte)Math.Max(G - 255 * amount, 0),
            (byte)Math.Max(B - 255 * amount, 0),
            A);
    }
    ...
    {
        return new Color(
            (byte)Math.Min(R + 255 * amount, 255),
            (byte)Math.Min(G + 255 * amount, 255),
            (byte)Math.Min(B + 255 * amount, 255),
            A);
    }
